...
public class TestRange {
	...
	public void expandToIncludeTest() {
        ...
        double value2 = -4.0;
        Range act_output2 = Range.expandToInclude(range, value);
        Range exp_output2 = new Range(-4.0, 3.0);
        
        Range range3 = new Range(-3.0,3.0);
        double value3 = 4.0;
        Range act_output3 = Range.expandToInclude(range, value);
        Range exp_output3 = new Range(-3.0,4.0);
        
        Range range4 = new Range(-3.0,3.0);
        double value4 = 1.0;
        Range act_output4 = Range.expandToInclude(range, value);
        Range exp_output4 = new Range(-3.0,1.0);
